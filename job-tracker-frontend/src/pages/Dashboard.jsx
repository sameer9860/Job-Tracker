...
function Dashboard() {
  ...
  if (profilePage) {
    return <ProfileView onClose={() => setProfilePage(false)} />;
  }
  ...
  return (
    <div
      style={{
        ...styles.page,
        background: isDark ? "#1f1f2e" : "#eef2ff",
        color: isDark ? "#f3f4f6" : "#1f2937",
      }}
    >
      {/* # HEADER */}
      <header
        style={{ ...styles.header, background: isDark ? "#2d2d3d" : "#fff" }}
      >
        <div>
          <h2 style={{ margin: 0 }}>Job Application Dashboard</h2>
          <p
            style={{ marginTop: "4px", color: isDark ? "#cbd5e1" : "#6b7280" }}
          >
      ...
      <section style={styles.statsGrid}>
        ...
        <StatCard
          label="Applied"
          value={data.status_counts.applied}
          color="#2563eb"
          theme={theme}
        />
        <StatCard
        ...
        <StatCard
          label="Offers"
          value={data.status_counts.offer}
          color="#10b981"
          theme={theme}
        />
        <StatCard
